...
$WPF_UI_DiskPartition_Disk_MBR = Add-GUIDisktoWindow -Prefix 'WPF_UI_DiskPartition_' -DiskType 'MBR'
...
Add-GUIPartitiontoDisk -Prefix 'WPF_UI_DiskPartition_Partition_' -PartitionType 'FAT32' -AddType 'Initial'-SizePixels 100
Add-GUIPartitiontoDisk -Prefix 'WPF_UI_DiskPartition_Partition_' -PartitionType 'ID76' -AddType 'Initial' -SizePixels 100
Add-GUIPartitiontoDisk -Prefix 'WPF_UI_DiskPartition_Partition_' -PartitionType 'ID76' -AddType 'Initial' -SizePixels 100
