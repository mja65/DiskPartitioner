function Get-ListofPackagestoInstall {
    param (
        ...
        # $ListofPackagestoInstallCSV = $Script:Settings.ListofPackagestoInstall
        ...
        foreach ($Line in $ListofPackagestoInstallImported) {
            ...
            ($SemanticVersion.Build -ge $PackageMinimumVersion.Build -or $SemanticVersion.Build -eq -1) -and `
            ($SemanticVersion.Revision -ge $PackageMinimumVersion.Revision -or $SemanticVersion.Revision -eq -1)){
        ...
        return ($RevisedListofPackagestoInstall | Where-Object {$_.KickstartVersion -eq $KickstartVersion})
}
