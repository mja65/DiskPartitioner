function Get-GUIADFKickstartReport {
    ...
    $WPF_ADFKickstartReporting = Get-XAML -WPFPrefix 'WPF_ADFKickstartReporting_' -XMLFile '.\Assets\WPF\Window_ADFKickstartReporting.xaml' -ActionsPath '.\UIActions\ADFKickstartReporting\' -AddWPFVariables
