function Get-MBRandRDBPartitionsforSelection  {
    ...
    elseif ($Script:GUICurrentStatus.ImportedPartitionType -eq 'RDB'){
        ...
        $null = Show-WarningorError -Msg_Header "Cannot Import Partitition" -Msg_Body "You have selected a native Amiga RDB image. Currently the Imager cannot import this partition type." -BoxTypeError -ButtonType_OK
        $Script:GUICurrentStatus.ImportedImagePath = $null
        $Script:GUICurrentStatus.SelectedPhysicalDiskforImport = $null
        $WPF_DP_ID_SourceofPartition_Value.Text = ""     
        ...
        $WPF_DP_ID_TypeofPartition_Value.Visibility = 'Hidden'
